...
export function LoginPage2() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // La navegación se maneja automáticamente por el useEffect
        } catch (error) {
                    ...
                    <div className="absolute inset-0 w-1/2 flex items-center justify-center p-12 z-10">
                        <div className="w-full max-w-md">
                            ...
                            <div className="flex justify-center mb-8">
                                <div
                                    className={`w-24 h-24 rounded-full flex items-center justify-center shadow-xl border-4 border-white/50 transition-all duration-500 ${email.length >= 2
                            ...
                            <div className="mb-8 text-center">
                                <h1 className="text-3xl font-bold text-gray-800 mb-2">Welcome to PulseOps</h1>
