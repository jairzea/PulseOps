        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
                ...
                <select
                    ...
                    className={`w-full px-4 py-2 bg-gray-800 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.resourceId ? 'border-red-500' : 'border-gray-700'
            ...
            <div>
                ...
                <select
                    ...
                    {...register('metricKey')}
                    disabled={isSubmitting || !!initialRecord}
                    className={`w-full px-4 py-2 bg-gray-800 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.metricKey ? 'border-red-500' : 'border-gray-700'
                        } ${initialRecord ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
            ...
            <div>
                ...
                <input
                    ...
                    className={`w-full px-4 py-2 bg-gray-800 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.week ? 'border-red-500' : 'border-gray-700'
                        }`}
                />
                {errors.week && (
            ...
            <div>
                ...
                <input
                    ...
                    disabled={isSubmitting}
                    step="any"
                    className={`w-full px-4 py-2 bg-gray-800 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.value ? 'border-red-500' : 'border-gray-700'
                        }`}
                />
                {errors.value && (
